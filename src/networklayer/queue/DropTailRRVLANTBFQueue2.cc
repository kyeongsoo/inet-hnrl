...
Define_Module(DropTailRRVLANTBFQueue2);

DropTailRRVLANTBFQueue2::DropTailRRVLANTBFQueue2()
{
}
...
bool DropTailRRVLANTBFQueue2::enqueue(cMessage *msg)
{
    int flowIndex = classifier->classifyPacket(msg);
...
cMessage *DropTailRRVLANTBFQueue2::dequeue()
{
    bool found = false;
...
void DropTailRRVLANTBFQueue2::sendOut(cMessage *msg)
{
    send(msg, outGate);
}

void DropTailRRVLANTBFQueue2::requestPacket()
{
...
void DropTailRRVLANTBFQueue2::triggerConformityTimer(int flowIndex, int pktLength)
{
...
void DropTailRRVLANTBFQueue2::finish()
{
